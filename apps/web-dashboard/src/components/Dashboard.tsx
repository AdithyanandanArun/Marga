...
export function Dashboard() {
  ...
  return <main style={s.shell} aria-label="Marga V2X resilience dashboard">
    ...
    <footer style={s.footer}><span>Mixed traffic: {vehicles.size} vehicles · {pedestrians.size} pedestrians</span><span style={{ marginLeft: 'auto' }}>Last verified update: {lastUpdate ? new Date(lastUpdate).toLocaleTimeString() : '—'}</span><Link to="/scenarios" style={s.footerLink}>Run scenario</Link></footer>
  </main>;
}
